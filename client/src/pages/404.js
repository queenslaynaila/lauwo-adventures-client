...
const Custom404 = () => {
  return (
    ...
    <header className="h-screen bg-[#1a1a1a] bg-cover bg-center bg-no-repeat bg-fixed w-full bg-[url('/g-4.jpg')]">
      ...
      <h1 className='text-4xl font-poly font-bold w-8/12 sm:w-6/12 text-white text-center leading-[50px] hover:text-yellow-400'>404 error</h1>
      <h1 className='text-4xl font-poly font-bold w-8/12 sm:w-6/12  text-center leading-[50px] text-yellow-400'>Oops! The page you Are looking for is Not available.</h1>
