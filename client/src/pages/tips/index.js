      ...
      <div className="inset bg-black/95">
        <div className="py-44 relative">
          <div className="flex  items-center justify-start gap-4 absolute left-4 top-28">
            ...
            <BiSearch className="text-white text-2xl absolute sm:left-96 left-32 cursor-pointer transition duration-500 ease-in-out hover:text-yellow-500"
          ...
          {filteredTips.length > 0 ? (
            ...
            <h1 className="text-xl font-semibold text-white  flex justify-center items-center">No tips found</h1>
          )}
        </div>
        </div>
      </div>
