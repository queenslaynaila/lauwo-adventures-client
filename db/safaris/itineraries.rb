puts "Creating Safari Itineraries"
puts "Creating 3 days safari itinerary"
SafariItinery.create! ([
  {
     ...
     safari_id: Safari.find_by(duration: '3 days').id
  },
...
puts "3 days safari itinerary created"

puts "Creating 4 days safari itinerary"
SafariItinery.create! ([
    {
       day: 1,
       title:"Arrival and Pick-up",
       ...
       safari_id: Safari.find_by(duration: '4 days').id
    },
...
puts '4 days safari itinerary created'

puts 'Creating 5 days safari itinerary'
SafariItinery.create! ([
    {
       day: 1,
       ...
       safari_id: Safari.find_by(duration: '5 days').id
    },
...
puts '5 days safari itinerary created'

puts 'Creating 6 days safari itinerary'
SafariItinery.create! ([
    {
       day: 1,
     ...
     {
      day: 7,
      title:" Explore lake Manyara national park & return to Arusha/Airport  ",
...
puts 'Created 6 days safari itinerary'

puts 'Creating 7 days safari itinerary'
SafariItinery.create! ([
    {
       day: 1,
...
puts 'Created 7 days safari itinerary'

puts 'Creating 8 days safari itinerary'
SafariItinery.create! ([
    {
       day: 1,
       title:"Arrival and Pick-up",
       ...
       safari_id: Safari.find_by(duration: '8 days').id
    },
...
puts "Created 8 days safari itinerary"

puts "Created #{SafariItinery.count} safari itineraries"
