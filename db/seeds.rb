 #Create mountains
meru = Mountain.create(mountain_name: "Mount Meru", description: "The fifth highest mountain in Tanzania.")
kilimanjaro = Mountain.create(mountain_name: "Mount Kilimanjaro", description: "The highest mountain in Tanzania and Africa.")

#Create routes for Meru ,routes duration and itineries
...
puts "meru route duration complete"

momela_4_days.itineries.create([
  {
    title: "Day 1",
    ...
    meals: "None",
    distance: "45 km",
    image_URL: "https://example.com/momela_day1.jpg",
    accomodation: "Lodging in Arusha",
    vegatation: "Tropical Forest",
    elevation: "1500m"
  },
  {
    title: "Day 2",
  ...
  },
  {
    ...
    distance: "15 km",
    image_URL: "https://example.com/momela_day4.jpg",
    accomodation: "None",
...
puts "meru intineries compke"

#Create routes for Kilimanajaro  
