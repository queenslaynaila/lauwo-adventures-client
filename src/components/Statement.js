          ...
          <div className="flex flex-col justify-center items-center ">
            ...
            <div className=" 2xl:mt-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 sm:gap-8 gap-16">
              <div className="flex flex-col justify-center items-center 2xl:h-[500px] w- bg-white border border-gray-200 rounded-lg shadow-2xl p-6 sm:p-8">
                <div className="flex justify-center items-center mb-6 w-16 h-16 mt-2  rounded-full bg-gray-100 ">
                  <FaGlobeAfrica className="w-8 h-8 md:w-10 md:h-10 text-gray-500  " />
                </div>
                <h1 className="text-3xl 2xl:text-4xl font-bold text-gray-900  ">
                  MISSION
                </h1>
                <hr className="border-t-2 font-gray border-gray-700 my-4 w-16" />
                <p className="text-base 2xl:text-xl font-normal text-gray-700   text-center leading-relaxed">
              ...
              <div className="flex flex-col justify-center items-center 2xl:h-[500px] w- bg-white border border-gray-200 rounded-lg shadow-2xl p-6 sm:p-8">
                <div className="flex justify-center items-center mb-6 w-16 h-16 rounded-full shadow-xl bg-gray-100  ">
                  <FaPenFancy className="w-8 h-8 md:w-10 md:h-10 text-gray-500  " />
                </div>
                <h1 className="text-3xl 2xl:text-4xl font-bold text-gray-900   mb-4">
                  VALUES
                </h1>
                <hr className="border-t-2 font-gray border-gray-700 my-4 w-16" />
                <p className="text-base 2xl:text-xl font-normal text-gray-700 text-center leading-relaxed">
