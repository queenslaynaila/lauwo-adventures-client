...
export default function Blogs() {
  ...
  return (
    <div className="px-4 py-8">
      ...
      <p className="p-1">
        Note, while you can make new blogs to show on the site, blogs are
        updated from the databse to the website after every 7 days to optimise
        the balance between speed and having relevant data.All blogs made before
        the 7 days expire, will be qeued in the website and will only reflect
        after the 7 days elapse.In regards to this, you can make a weekly blog
        schedule.
      </p>
