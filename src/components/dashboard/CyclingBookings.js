...
export default function CyclingBookings() {
  const [data, setData] = useState([]);
  const [selectedRows, setSelectedRows] = useState([]);
  const [searchValue, setSearchValue] = useState('');

  useEffect(() => {
    fetch('https://lauwo-adventures-api.onrender.com/cycling_bookings')
  ...
  return (
    <div className="px-4 py-8 w-full ">
      <ToastContainer />
      <h1 className="text-2xl font-bold mb-4">Cycling Tour Bookings</h1>
      <p>
