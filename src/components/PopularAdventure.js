...
const PopularAdventure = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Immerse yourself in the rich cultural heritage of Tanzania with our guided cultural tours.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {services.map((service, index) => (
           ...
           <div
            ...
            >
              <div className="h-64 w-full bg-cover rounded-t-lg mb-4" style={{ backgroundImage: `url(${service.image})` }}></div>
              <div className='p-4'>
