          ...
          >
            {(close) => (
              <div className="modal">
                ...
                <ReviewModal tagline={tagline} name={name} content={content} 
           rating={rating} />
              </div>
            )}
          </Popup>
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {reviews.map((review, index) => (
           <ReviewCard key={index} tagline={review.tagline} name={review.name} content={review.content} 
           rating={review.rating}/>
        ))}
      </div>
      <div className="flex justify-center mt-8">
        <Link href="https://www.tripadvisor.com/Attraction_Review-g317084-d17424491-Reviews-Lauwo_Adventures-Moshi_Kilimanjaro_Region.html" target="_blank" rel="noopener noreferrer" className="bg-yellow-500 text-white px-6 py-3 rounded font-medium font-poly">
