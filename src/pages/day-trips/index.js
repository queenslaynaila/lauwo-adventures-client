  ...
  return (
    <div className="font-poly">
      <Head>
        ...
        <meta
          name="description"
          content="Join our day trips for a lightning-fast adventure! Warning: side effects may include unforgettable memories and a serious case of wanderlust."
        />
        <meta
          name="keywords"
          content="Tanzania, day trips, adventure, wanderlust"
        />
      </Head>
